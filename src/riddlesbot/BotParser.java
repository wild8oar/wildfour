            ...
            switch (parts[0]) {
                ...
                case "action":
                    if (parts[1].equals("move")) { /* move requested */
                    	bot.setBotId(currentState.getField().getMyId() + 1);
                    	bot.setRound(2 * currentState.getRoundNumber() - 1 + currentState.getField().getMyId());
                    	bot.setTime(currentState.getTimebank());
                    	bot.setField(currentState.getField());
