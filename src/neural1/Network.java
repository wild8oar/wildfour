...
public class Network {
 ...
 public void writeToClass (String classname) throws IOException {
	 ...
	 writer.println("import neural1.Network;\n");
	 writer.println("public class " + classname + " {\n");
	 writer.println("private static final int inputCount = " + inputCount + ";");
	 writer.println("private static final int hiddenCount = " + hiddenCount + ";");
	 writer.println("private static final int outputCount = " + outputCount + ";\n");
	 writer.println("private static final double[] matrix = " + arrayToString(matrix) + ";\n");
	 writer.println("private static final double[] thresholds = " + arrayToString(thresholds) + ";\n");
	 writer.println("\n  public static Network getNetwork(double learnRate, double momentum) {");
	 writer.println("    Network net = new Network(inputCount, hiddenCount, outputCount, learnRate, momentum);");
	 writer.println("    net.setMatrix(matrix);");
	 writer.println("    net.setThresholds(thresholds);");
	 writer.println("    return net;\n  }\n");
	 writer.println("\n}");
	 writer.close();
 }
 
 private String arrayToString(double[] array) {
	 StringBuilder sb = new StringBuilder(10*array.length);
	 sb.append("{ " + array[0] + ",\n");
